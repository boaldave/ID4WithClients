...
namespace IdentityServer4.Quickstart.UI
{
    public class AccountService
    {
        ...
        public async Task<LoginInputModel> BuildLoginViewModelAsync(string returnUrl)
        {
        ...
        public async Task<LoginInputModel> BuildLoginViewModelAsync(LoginInputModel model)
        {
